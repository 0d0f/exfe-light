define(function (require) {
  ...
  var newbieGuide = [
    ...
    '<div class="newbie nbg-1">'
      ...
      + '<p>Here list your identities. Identity is your online representative, i.e. email, mobile number and account from Twitter, Facebook, <span class="strike">Google, etc.</span> (soon to support) You can gather with different group of people as different identity, or use them as alternative way of notification.</p>'
    ...
    '<div class="newbie nbg-2">'
      ...
      + 'datings, sports, trips, etc. For any purpose you need to gather people, <span class="x-sign">EXFE</span> them!'
      + '</p>'
