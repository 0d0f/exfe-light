...
/*! desktop@2a.10 2013-06-08 09:06:31 */
(function(e) {
  "use strict";
  function t(e, t, n) {
  ...
  J.event = {
    ...
    remove: function(e, t, i, n, r) {
      ...
      if (g && (h = g.events)) {
        for (t = J.trim(At(t || "")).split(" "), a = 0; t.length > a; a++) if (s = Mt.exec(t[a]) || [], 
        o = l = s[1], c = s[2], o) {
  ...
  J.fn.extend({
    ...
    J.fn[e] = function(i, n) {
      ...
      r = this.length > 1 && !Ht[e] ? J.unique(r) : r, this.length > 1 && Ot.test(e) && (r = r.reverse()), 
  ...
  J.fn.extend({
    ...
    var r, a, s, o = e[0];
    return i = i || j, i = !i.nodeType && i[0] || i, i = i.ownerDocument || i, !(1 === e.length && "string" == typeof o && 512 > o.length && i === j && "<" === o.charAt(0)) || Yt.test(o) || !J.support.checkClone && Kt.test(o) || !J.support.html5Clone && Vt.test(o) || (a = !0, 
  ...
  Ci = Pi.exec(Ei.toLowerCase()) || [], J.fn.load = function(e, i, n) {
    ...
    i = t) : i && "object" == typeof i && (a = "POST"), J.ajax({
      ...
      s = arguments, o.html(r ? J("<div>").append(e.replace(Di, "")).find(r) : e);
    }), this;
  ...
  var Yi, Vi, Gi = /^(?:toggle|show|hide)$/, Ki = RegExp("^(?:([-+])=|)(" + Q + ")([a-z%]*)$", "i"), Zi = /queueHooks$/, Ji = [ O ], Qi = {
    "*": [ function(e, t) {
...
TWEEN.Tween = function(e) {
  ...
  var m = function(e, t, i) {
    ...
    if (d) {
      ...
      if (1 === f) {
        ...
        var _ = r('<div id="read-only-browsing" data-destory="true" data-widget="dialog" data-dialog-type="read_only">></div>');
        return _.data("settings", y), r("#app-tmp").append(_), _.trigger("click"), !1;
      }
      if (2 === f) {
        var b = y.user_id;
        if ("SIGNIN" === p && n && n !== b) {
        ...
        e.preventDefault(), n && n !== b ? m(a, g, function() {
          var e = r('<div id="merge-identity" data-destory="true" data-widget="dialog" data-dialog-type="browsing_identity"></div>');
          e.data("settings", {
            browsing: y,
            user: s,
  ...
  var t = e("jquery"), i = [], n = {
    ...
    if (e) {
      ...
      t(".cross-opts .saving").show(), Api.request("addConversation", {
        ...
        $ = e.post.created_at, t(".cross-opts .saving").hide(), I(e.post), V.emit("app:cross:edited");
      }, function(e) {
        t(".cross-opts .saving").hide();
        var i = !e.meta || 401 !== e.meta.code && 403 !== e.meta.code ? "" : "no_permission";
        V.emit("app:cross:edited", {
    ...
    b(), x(), C(Cross.place), E(), T(), D(), A(Cross.place);
  }, O = function(e) {
    var t = {
      resources: {
        exfee_id: Exfee.id
  ...
  }), V.on("xapp:cross", function(e, t, i, n, r, a) {
    if (e > 0) R(e); else if (null === e) switch (t && (curIdentity = t, Api.setToken(r)), 
    H(i, n), a) {
     case "accept":
      ExfeeWidget.rsvpMe("ACCEPTED"), D();
      break;
...
define("lightsaber", function(e, t, i) {
  ...
  var d = function(e, t, i, n, r, o, c, d, u) {
    ...
    a.request("getCrossByInvitationToken", {
      ...
      console.dir(t);
      var i = t.authorization, n = t.browsing_identity, r = n && n.connected_user_id, a = t.cross_access_token, h = t.read_only, m = t.action, g = t.cross;
      ...
      if ((p && f === r || i && (p = i)) && r > 0 || !m) return s.once("app:user:signin:after", function() {
        e.redirect("/#!" + g.id);
