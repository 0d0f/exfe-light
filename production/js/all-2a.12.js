...
/*! desktop@2a.12 2013-06-25 05:06:42 */
(function(e) {
  "use strict";
  function t(e, t, n) {
...
TWEEN.Tween = function(e) {
  ...
  "use strict";
  var i = e("jquery"), n = e("rex"), r = e("bus"), a = e("api"), s = e("util"), o = e("store"), l = e("handlebars"), c = e("dialog"), d = {}, u = Date.now || function() {
    return new Date().getTime();
  }, h = function(e, t, n) {
    var r, a;
    e.on("mousedown", n, function(n) {
      ...
      var s = i(this);
      a && (clearTimeout(a), a = void 0), r = u(), a = setTimeout(function() {
        e.find(t).prop("type", "text"), s.addClass("icon16-pass-show").removeClass("icon16-pass-hide");
      }, 500);
    }).on("mouseup", n, function(n) {
      return a && (clearTimeout(a), a = void 0), e.find(t).prop("type", "password"), i(this).removeClass("icon16-pass-show").addClass("icon16-pass-hide"), 
  ...
  t.dialogs = d, d.identification = {
    ...
    addIdentity: function p(e, t, n, r) {
