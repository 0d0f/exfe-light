  ...
  $(function () {
    ...
    .on('click.home', function (e) {
      ...
      if (!$e.hasClass('gather-wrapper')
          ...
          /*
          $START.addClass(' xbtn-start-hover');
          $START
            .delay(233, 'trifio')
            .queue('trifio', function () {
              $START.removeClass('xbtn-start-hover');
            })
            .dequeue('trifio');
          */
      }
    ...
    //.on('click.home', '.x-home .modal-backdrop', function () {
      ...
      //})
    .on('hover.name', '.xbtn-start', function (e) {
      var isEnter = e.type === 'mouseenter';
      $(this).toggleClass('trifio', !isEnter).toggleClass('xbtn-start-hover');
    })
    .on('click.home', '.x-home .exfe-toy, .xbtn-start', function (e) {
          var settings = {
            options: {
